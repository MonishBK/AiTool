...
const Banner = () => {
  ...
  return (
    <Box sx={{ height:'80vh', display:'flex', color:'textColor.main', flexDirection:'column',  justifyContent:'center', alignItems:'center'}} > 
        <Typography variant="h1" sx={{textAlign:"center", fontSize:{lg:'3rem', md:'2.5rem', sm:'2rem', xs:'1.1rem'}}} >Welcome to <br /> Revolutionizing the AI Landscape</Typography>
        ...
        Embark on a journey into the future of Artificial Intelligence with [Your Website Name].  
